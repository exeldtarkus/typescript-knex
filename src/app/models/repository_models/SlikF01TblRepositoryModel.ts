...
type ColumnNames = '*' | keyof ISlikF01TblQueryOutput | '*';
interface ISlikF01TblQueryParams extends IRepositoryParam<ColumnNames> {
  q?: {
    id?: number;
    cif?: number;
    period?: string;
...
interface ISlikF01TblQueryOutput {
  Period: string;
  Flag_Detail: string;
...
interface ISlikF01TblUpdatedParams {
  Period?: string;
  Flag_Detail?: string;
  Nomor_Rekening_Fasilitas?: string;
  Nomor_CIF_Debitur?: string;
