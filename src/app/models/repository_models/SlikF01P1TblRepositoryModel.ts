...
type ColumnNames = '*' | keyof ISlikF01P1TblQueryOutput;

interface ISlikF01P1TblQueryParams extends IRepositoryParam<ColumnNames> {
  q?: {
    id?: number;
    cif?: number;
    period?: string;
...
interface ISlikF01P1TblQueryOutput {
  Period: string;
  Flag_Detail: string;
...
interface ISlikF01P1TblUpdatedParams {
  Period?: string;
  Flag_Detail?: string;
  Nomor_Rekening_Fasilitas?: string;
  Nomor_CIF_Debitur?: string;
