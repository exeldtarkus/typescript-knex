...
type ColumnNames = '*' | keyof ISlikD01TblQueryOutput;

interface ISlikD01TblQueryParams extends IRepositoryParam<ColumnNames> {
  q?: {
    id?: number;
    cif?: number;
    period?: string;
...
interface ISlikD01TblQueryOutput {
  Period: string;
  Flag_Detail: string;
...
interface ISlikD01TblUpdatedParams {
  Period?: string;
  Flag_Detail?: string;
  Nomor_CIF_Debitur?: string;
  Jenis_Identitas?: string | null;
