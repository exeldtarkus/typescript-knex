...
type ColumnNames = '*' | keyof ISlikD01P1TblQueryOutput;

interface ISlikD01P1TblQueryParams extends IRepositoryParam<ColumnNames> {
  q?: {
    id?: number;
    cif?: number;
    period?: string;
...
interface ISlikD01P1TblQueryOutput {
  Period: string;
  Flag_Detail: string;
...
interface ISlikD01P1TblUpdatedParams {
  Period?: string;
  Flag_Detail?: string;
  Nomor_CIF_Debitur?: string;
  Jenis_Identitas?: string | null;
